...
export const FORMULAS: FormulaSpec[] = [
  { formulaId:"asymmetric_crescent",version:"1.0.0",label:"Asymmetric Crescent",flowDirection:"counterclockwise",anchors:[{role:"hero",clock:"8:00",strength:1}],silenceArcs:[{from:"12:30",to:"3:30"}],focalRegions:[{from:"7:00",to:"9:30"}],roleRatios:{greenery:0.55,focal:0.15,secondary:0.15,accent:0.10,ribbon:0.05},constraints:{preserveOpenCenter:true}},
